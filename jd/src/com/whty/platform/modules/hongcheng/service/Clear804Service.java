...
public class Clear804Service extends BaseService {

	private static Logger logger = LoggerFactory.getLogger(Clear804Service.class);
	 ...
	 * @throws Exception
	 */
	public static HashMap<String, Object> sendIbspIIPosMessage804(String[] messageBodySts) throws Exception {
		String sendMsg = null;
