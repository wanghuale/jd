...
<body>
	...
	<form:form id="inputForm" modelAttribute="ticket" action="${ctx}/dangpu/ticket/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <form:input path="card" htmlEscape="false" maxlength="20" class="required card"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
               <form:input path="interest" htmlEscape="false" maxlength="20" class="required number"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">备注:</label>
			<div class="controls">
                <form:textarea path="remark" htmlEscape="false" maxlength="20" class="required"/>
			</div>
		</div>
