...
public class HttpURL {
	...
	private static final int _minute = 1000 * 30;
	...
	public String doPost(String strURL, Map<String, String> argsMap) throws Exception {
		return doPost(strURL, argsMap, true);
	}
	 ...
	 * @throws Exception
	 * */
	public String doPost(String strURL, Map<String, String> argsMap, boolean isencode) throws Exception {
		...
		try {
			...
			byte[] b = this.parseParamMap(argsMap, isencode).getBytes();
	 ...
	 * */
	private String parseParamMap(Map<String, String> argsMap, boolean isencode) throws Exception {
		...
		while (itor.hasNext()) {
			...
			sbParams.append("=");
			if (isencode) {
				sbParams.append(XMLFileUtil.encode(argsMap.get(param)));
			} else {
