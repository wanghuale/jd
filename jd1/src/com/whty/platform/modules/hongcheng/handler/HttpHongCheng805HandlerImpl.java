...
/**
 * 洪城一卡通清算中心联机交易报文：联机充值交易
 * @author jincheng
 * @date 2013-11-29
 */
@Service("HttpHongCheng805Handler")
public class HttpHongCheng805HandlerImpl implements HttpBusinessHandler {

	private static Logger logger = LoggerFactory.getLogger(HttpHongCheng805HandlerImpl.class);
