 ...
 * 
 */
@Service("httpQD401Handler")
public class HttpQD401HandlerImpl implements HttpBusinessHandler {
	private static Logger logger = LoggerFactory.getLogger(HttpQD401HandlerImpl.class);
	...
	public HttpBusinessResponse handler(HttpBusinessRequest httpBusinessRequest) throws Exception {
		...
		// 解密
		replyMessage = HttpQD401Utils.encodeJsonString(replyMessage, mallKey);
