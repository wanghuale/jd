...
<body>
	<ul class="nav nav-tabs">
		<li  class="active"><a href="${ctx}/info/modifyPWD">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="consumer" action="${ctx}/info/savePWD" method="post" class="form-horizontal">
		<form:hidden path="id"/>
