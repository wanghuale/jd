...
public class Clear805Service extends BaseService {

	private static Logger logger = LoggerFactory.getLogger(Clear805Service.class);
	 ...
	 * @throws Exception
	 */
	public static HashMap<String, Object> sendIbspIIPosMessage805(String[] messageBodySts) throws Exception {
		String sendMsg = null;
