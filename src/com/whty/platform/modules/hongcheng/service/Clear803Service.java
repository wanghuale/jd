...
public class Clear803Service extends BaseService {

	private static Logger logger = LoggerFactory.getLogger(Clear803Service.class);
	 ...
	 * @throws Exception
	 */
	public static HashMap<String, Object> sendIbspIIPosMessage803(String[] messageBodySts) throws Exception {
		String sendMsg = null;
